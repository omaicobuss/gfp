            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 border border-gray-100">
                <form action="{{ route('expenses.update', $expense) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <x-text-input id="description" name="description" type="text" class="mt-1 block w-full" placeholder="Ex: Compras do Supermercado..." :value="old('description', $expense->description)" required autofocus />
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="relative mt-1">
                                ...
                                <input type="number" step="0.01" min="0.01" name="amount" id="amount" value="{{ old('amount', $expense->amount) }}" placeholder="0,00" class="pl-10 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm" required />
                            </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 items-center">
                        ...
                        <div class="pt-6">
                            <label for="is_paid" class="inline-flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200 hover:bg-gray-100 cursor-pointer w-full transition">
                                <input id="is_paid" type="checkbox" name="is_paid" value="1" {{ old('is_paid', $expense->is_paid) ? 'checked' : '' }} class="rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500 w-5 h-5">
                    ...
                    <div>
                        ...
                        <textarea id="notes" name="notes" rows="3" class="mt-1 block w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm text-sm" placeholder="Adicione qualquer detalhe adicional sobre este gasto...">{{ old('notes', $expense->notes) }}</textarea>
