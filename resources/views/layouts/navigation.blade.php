            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2">
                        <span class="font-bold text-xl text-indigo-600 tracking-tight">GFP</span>
                        <span class="text-xs text-gray-500 font-medium hidden md:inline">Gestão Financeira Pessoal</span>
                    </a>
                </div>
